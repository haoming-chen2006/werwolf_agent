...
class GameState:
    def __init__(self, players: List[str], roles: Dict[str, RoleName], alignments: Dict[str, Alignment]):
        ...
        self.doctor_potions: Dict[str, bool] = {}  # Track if doctor used potion
    ...
    def get_winner(self) -> Alignment | Literal["ongoing"]:
    ...
    def alive_players(self) -> List[str]:
        return self.living_players()

    def add_public_chat(self, player_id: str, content: str) -> None:
    ...
    def get_inspections(self, seer: str) -> List[Dict[str, Any]]:
        return self.inspection_log.get(seer, [])
